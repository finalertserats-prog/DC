  ...
  return (
    <div className="overflow-x-auto h-full rounded-b-xl">
      <table className="min-w-full divide-y divide-gray-200">
        <thead className="bg-muted/50/90 sticky top-0 shadow-sm z-10 backdrop-blur-md">
