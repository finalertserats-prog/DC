        ...
        <div className="min-h-screen bg-[#0c0e1a] text-white font-sans">
                ...
                <div className="flex items-center gap-3">
                    {isLoggedIn ? (
                        <>
                            ...
                            <div className="flex items-center gap-3 bg-card/5 border border-white/10 px-4 py-1.5 rounded-lg">
            ...
            <div className="pt-24 pb-16 px-8 max-w-5xl mx-auto">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-3 gap-5 mb-6">
                        {[
                            ...
                            <div key={c.title} className="bg-card/5 border border-white/10 rounded-2xl p-5">
                ...
                <section className="mb-12">
                    ...
                    <div className="grid grid-cols-3 gap-5 mb-6">
                        {PHASES.map(p => (
                            <div key={p.title} className="bg-card/5 border border-white/10 rounded-2xl p-5">
                                ...
                                <ol className="space-y-2">
                                    {p.steps.map((s, i) => (
                                        <li key={i} className="flex items-start gap-2 text-xs text-gray-400">
                                            <span className="w-4 h-4 rounded-full bg-card/10 text-white text-[9px] font-bold flex items-center justify-center shrink-0 mt-0.5">{i + 1}</span>
                                            {s}
                                        </li>
                                    ))}
                                </ol>
                    ...
                    <div className="grid grid-cols-2 gap-5">
                        <div className="bg-card/5 border border-white/10 rounded-2xl p-5">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {TECH.map(t => (
                            <div key={t.name} className="bg-card/5 border border-white/10 rounded-xl p-4 flex items-start gap-3">
