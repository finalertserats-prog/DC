                ...
                for (const db of dbs) {
                    ...
                    for (const table of tables) {
                        try {
                            ...
                            await pgPool.query(`INSERT INTO explorer_observability (connection_id, db_name, table_name, total_count, today_count, previous_count, target_date) VALUES ($1, $2, $3, $4, $5, $6, $7) ON CONFLICT (connection_id, db_name, table_name, target_date) DO UPDATE SET total_count = EXCLUDED.total_count, today_count = EXCLUDED.today_count, previous_count = EXCLUDED.previous_count`, [conn.id, db, table, total, today, previous, targetDate]);
                            totalTablesProfiled++;
